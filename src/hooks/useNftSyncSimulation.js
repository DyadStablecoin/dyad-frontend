...
const TENDERLY_FORK_API = `https://api.tenderly.co/api/v1/account/${import.meta.env.VITE_TENDERLY_USER}/project/${import.meta.env.VITE_TENDERLY_PROJECT}/fork`;
  ...
  useEffect(() => {
    async function updateXP() {
      ...
      const gp = new ethers.providers.JsonRpcProvider(
        `https://${CURRENT_NETWORK}.infura.io/v3/${import.meta.env.VITE_INFURA_KEY}`
      );
      ...
      const TENDERLY_FORK_ACCESS_URL = `https://api.tenderly.co/api/v1/account/${import.meta.env.VITE_TENDERLY_USER}/project/${import.meta.env.VITE_TENDERLY_PROJECT}/fork/${forkId}`;
